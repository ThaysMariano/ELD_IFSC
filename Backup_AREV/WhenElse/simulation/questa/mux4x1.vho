...
-- Equation(s):
-- \Y~0_combout\ = (\Sel[1]~input_o\ & (((\Sel[0]~input_o\)))) # (!\Sel[1]~input_o\ & ((\Sel[0]~input_o\ & ((\X[1]~input_o\))) # (!\Sel[0]~input_o\ & (\X[0]~input_o\))))
...
-- Equation(s):
-- \Y~1_combout\ = (\Sel[1]~input_o\ & ((\Y~0_combout\ & ((\X[3]~input_o\))) # (!\Y~0_combout\ & (\X[2]~input_o\)))) # (!\Sel[1]~input_o\ & (((\Y~0_combout\))))
